...
class MMNode {
  ...
  type: 'object' | 'process' | 'state' | 'project' | 'projectlock' | 'remark' | 'objectParent' | 'processParent' | 'processMax' | 'edgePoint' | 'cross';
  label: string;
  ...
  constructor(id: string, type: 'object' | 'process' | 'state' | 'project' | 'projectlock' | 'remark' | 'objectParent' |'processParent' | 'processMax' | 'edgePoint' | 'cross', label: string) {
    this.id = id;
    this.label = label;
    this.type = type;
    this.parent = null;
