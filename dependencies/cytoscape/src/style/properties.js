...
(function(){
  ...
  styfn.types = {
    ...
    arrowShape: { enums: [ 'tee', 'triangle', 'triangle-tee','circle-triangle', 'triangle-cross', 'triangle-backcurve', 'vee', 'square', 'circle', 'diamond', 'chevron', 'none', 'triangle-inner-triangle', 'triangle-inner-circle','circle-tee' ,'vee-cross' ,'fbvee','nortee','exctee','chevron-cross','vee-crossnew'] },
